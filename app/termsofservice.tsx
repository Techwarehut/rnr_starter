...
import { H1, H2, H3, Small } from "~/components/ui/typography";
...
const termsofservice = () => {
  return (
    <>
      {Platform.OS === "web" && (
        <Helmet>
          <title>Terms of Service - Veylo</title>

          <meta
            name="description"
            content="Read the terms and conditions for using Veylo. Understand your rights, responsibilities, and the rules for accessing our services."
          />
          <meta property="og:title" content="Terms of Service - Veylo" />
          <meta
            property="og:description"
            content="Read the terms and conditions for using Veylo. Understand your rights and responsibilities."
          />
          <meta
            property="og:image"
          ...
          <meta
            property="og:url"
            content="https://veylo.app/terms-of-service"
          />
          <meta property="og:type" content="website" />

          <meta name="twitter:card" content="summary_large_image" />
          <meta name="twitter:title" content="Terms of Service - Veylo" />
          <meta
          ...
          <link rel="canonical" href="https://veylo.app/terms-of-service" />
        </Helmet>
      )}
      <ScrollView>
        <View className="flex bg-secondary justify-center p-6 md:p-12 rounded-md gap-4">
          ...
          <Text>
            Welcome to Veylo! These Terms of Service ("Terms") govern your
            access to and use of the Veylo mobile application, website, and
            related services (collectively, the "Service"). By accessing or
            using the Service, you agree to comply with and be bound by these
            Terms. If you do not agree to these Terms, you should not use the
            Service.
          </Text>
        </View>
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <Text className="text-bold">Account Types:</Text>
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <Text>
            ...
            plans, premium tools, or transaction services. All payment
            obligations are subject to the terms of your selected subscription
            or usage plan. Fees may be subject to change, and you will be
            notified of any changes prior to the implementation.
          </Text>
          <Text>
            Payments for services rendered by Account Owners through Veylo may
            be processed through third-party payment providers, such as Stripe
            or other payment gateways. By using the Service, you agree to the
            terms and conditions of these third-party services.
          </Text>
        </View>
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <Text>
            ...
            by our Privacy Policy. By using the Service, you agree to the
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <Text>
            ...
            support. Veylo reserves the right to suspend or terminate your
            account for violations of these Terms, illegal activity, or if we
            believe your use of the Service presents a risk to other users.
          </Text>
          <Text>
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <Text>
            ...
            trademarks, are owned by Veylo or licensed from third parties. You
            are granted a limited, non-exclusive, non-transferable license to
            access and use the Service as intended. You may not copy, modify,
            distribute, or reverse engineer any part of the Service without
            prior written consent from Veylo.
          </Text>
        </View>
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <Text>
            ...
            officers, employees, agents, or licensors shall not be liable for
            any indirect, incidental, special, consequential, or punitive
            damages, or any loss of profits, data, or business arising out of or
            in connection with the use or inability to use the Service, even if
            Veylo has been advised of the possibility of such damages.
          </Text>
        </View>
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <Text>
            ...
            claim, demand, liability, or expense (including reasonable
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <Text>
            ...
            laws principles. Any disputes arising from or related to these Terms
            will be resolved through binding arbitration in [Location], under
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <View className="pl-4 md:pl-12 native:mb-8">
            <Text>Email: VeyloApp@gmail.com</Text>
            <Text>Phone: (289) 356 3784</Text>
            <Text>Mailing Address: 67 Chant Cres, Ajax, ON L1T 0M7</Text>
          </View>
        </View>
