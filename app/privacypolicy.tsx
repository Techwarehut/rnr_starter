...
const privacypolicy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy - Veylo</title>

        <meta
          name="description"
          content="Learn how Veylo protects your personal information. Review our privacy policy for details on data usage, storage, and security practices."
        />
        <meta property="og:title" content="Privacy Policy - Veylo" />
        <meta
          property="og:description"
          content="Learn how Veylo protects your personal information. Review our privacy policy for details on data security practices."
        />
        <meta
          property="og:image"
          content="https://veylo.app/VeyloFacebookCover.png"
        />
        <meta property="og:url" content="https://veylo.app/privacy-policy" />
        <meta property="og:type" content="website" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Privacy Policy - Veylo" />
        <meta
          name="twitter:description"
          content="Learn how Veylo protects your personal information. Review our privacy policy for details."
        />
        <meta
          name="twitter:image"
          content="https://veylo.app/VeyloFacebookCover.png"
        ...
        <link rel="canonical" href="https://veylo.app/privacy-policy" />
      </Helmet>
      ...
      <ScrollView>
        <View className="flex bg-secondary justify-center p-6 md:p-12 rounded-md gap-4">
          ...
          <Text>
            At Veylo, we respect your privacy and are committed to protecting
            your personal data. This Privacy Policy outlines the information we
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <View className="flex justify-center p-6 md:p-12 gap-4">
            ...
            <Text>
              ...
              about your actual location, such as GPS signals and information
              sent by your mobile device. This helps us provide location-based
              services.
            </Text>
            ...
            <Text>
              ...
              App, including hardware model, operating system, and other
              technical data.
            </Text>
          </View>
        </View>
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <ul className="list-decimal pl-12 mt-2 space-y-2 text-foreground">
            ...
            <li>
              To analyze usage data for performance and improve the App's
              features
            </li>
          </ul>
        </View>
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <ul className="list-decimal pl-12 mt-2 space-y-2 text-foreground">
            <li>
              ...
              App, conducting business activities, or servicing users (e.g.,
              cloud hosting, customer service, etc.).
            </li>
            <li>
              <strong>For Legal Compliance:</strong> We may disclose your data
              if required to do so by law, such as to comply with a subpoena or
              other legal process.
            </li>
          </ul>
        </View>
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <Text>
            ...
            to, correct, update, or delete the personal information we hold
            about you. You can also object to the processing of your personal
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8 gap-4">
          ...
          <Text>
            ...
            to review the privacy policies of those websites before providing
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <Text>
            ...
            we will take steps to delete that information as quickly as
            possible.
          </Text>
        </View>
        ...
        <View className="flex justify-center p-6 md:p-12  mx-2 md:mx-8  gap-4">
          ...
          <Text>
            ...
            at the top of the page. We encourage you to review this Privacy
